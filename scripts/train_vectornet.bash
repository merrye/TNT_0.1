...
# CUDA_VISIBLE_DEVICES=1,0 python -m torch.distributed.launch --nproc_per_node=2 train_vectornet.py -d dataset/interm_data_small -o run/vectornet/ -a -b 256 -c -m --lr 0.0010 -luf 10 -ldr 0.5
