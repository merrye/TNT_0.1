...
# python -m torch.distributed.launch --nproc_per_node=1 train_net.py -d ../TNT-Trajectory-Prediction-main/dataset/interm_data -o run/net/ -a -b 128 -c -m --lr 0.0012 -luf 10 -ldr 0.3
